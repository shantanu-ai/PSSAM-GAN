...
class Experiments:
    ...
    def run_all_experiments(self, train_path, test_path, iterations, ps_model_type):
        ...
        for iter_id in range(iterations):
            ...
            file1.write("\nToday's date: {0}\n".format(date.today()))
            file1.write("Iter: {0}, bias_att_DCN_PD: {1}, bias_att_DCN_PM_GAN: {2},  "
                        "bias_att_DCN_PM_GAN_02: {3}, bias_att_DCN_PM_GAN_05: {4}, "
                        "policy_risk_DCN_PD: {1}, policy_risk_DCN_PM_GAN: {2},  "
                        "policy_risk_DCN_PM_GAN_02: {3}, policy_risk_PM_GAN_05: {4}, "

                        .format(iter_id, dcn_pd_bias_att, dcn_pm_gan_bias_att,
                                dcn_pm_gan_02_bias_att, dcn_pm_gan_05_bias_att,
                                dcn_pd_policy_risk, dcn_pm_gan_policy_risk,
        ...
        file1.write("\n--" * 20)
        file1.write("\nModel 3: DCN PM GAN Dropout 0.2")
