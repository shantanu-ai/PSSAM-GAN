...
class PSM_Manager:
    def match_using_prop_score(self, tuple_treated, tuple_control):
        # do ps match
        np_treated_df_X, np_treated_ps_score = tuple_treated
        np_control_df_X, np_control_ps_score = tuple_control
    ...
    def filter_matched_and_unmatched_control_samples(self, np_control_df_X,
                                                     ...
                                                     matched_control_indices,
                                                     unmatched_control_indices):
        tuple_matched_control = self.filter_control_groups(np_control_df_X,
                                                           np_control_ps_score,
                                                           matched_control_indices)

        tuple_unmatched_control = self.filter_control_groups(np_control_df_X,
                                                             np_control_ps_score,
                                                             unmatched_control_indices)
