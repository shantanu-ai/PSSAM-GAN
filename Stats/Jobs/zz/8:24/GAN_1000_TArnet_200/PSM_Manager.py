...
class PSM_Manager:
    def match_using_prop_score(self, tuple_treated, tuple_control):
        # do ps match
        np_treated_df_X, np_treated_ps_score, np_treated_df_Y_f, np_treated_df_e = tuple_treated
        np_control_df_X, np_control_ps_score, np_control_df_Y_f, np_control_df_e = tuple_control
