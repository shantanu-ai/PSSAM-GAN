...
class DCN_Experiments:
    ...
    def evaluate_DCN_Model(self, tensor_treated_train_original, tensor_control_train_original,
        ...
        dcn_pm_gan_eval_drp_02_dict = self.evaluate_DCN_PD(tensor_treated_balanced, tensor_control_balanced,
        ...
        dcn_pm_gan_eval_drp_05_dict = self.evaluate_DCN_PD(tensor_treated_balanced, tensor_control_balanced,
