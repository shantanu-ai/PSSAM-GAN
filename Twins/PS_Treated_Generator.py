...
class PS_Treated_Generator:
    ...
    def __get_balanced_dataset_using_DCN(self, treated_simulated, ps_score_list_treated_np,
        ...
        print("---> Semi supervised training completed...")
        np_treated_gen_f = Utils.convert_to_col_vector(simulated_treated_Y["y_f_list"])
        np_treated_y_0 = Utils.convert_to_col_vector(simulated_treated_Y["y_0_list"])
        np_treated_y_1 = Utils.convert_to_col_vector(simulated_treated_Y["y_1_list"])
        np_treated_x, np_treated_ps, np_treated_f, np_treated_y_0, np_treated_y_1 = \
            self.__get_balanced_treated(treated_simulated,
                                        ps_score_list_treated_np,
                                        np_treated_gen_f,
                                        np_treated_y_0,
    ...
    def __get_balanced_control(tuple_matched_control, tuple_unmatched_control):
        ...
        np_control_unmatched_y_0 = tuple_unmatched_control[3]
        np_control_unmatched_y_1 = tuple_unmatched_control[4]
        ...
        np_control_matched_y_0 = tuple_matched_control[3]
        np_control_matched_y_1 = tuple_matched_control[4]
        ...
        np_control_y_0 = np.concatenate((np_control_unmatched_y_0, np_control_matched_y_0),
                                        axis=0)
        np_control_y_1 = np.concatenate((np_control_unmatched_y_1, np_control_matched_y_1),
                                        axis=0)

        return np_control_x, np_control_ps, np_control_f, np_control_y_0, np_control_y_1

    def __get_balanced_treated(self, treated_simulated, ps_score_list_treated_np,
                               np_treated_gen_f, np_treated_gen_y_0,
                               np_treated_gen_y_1):
        ...
        np_original_Y_0 = self.treated_tuple_full[3]
        np_original_Y_1 = self.treated_tuple_full[4]

        np_treated_x = np.concatenate((np_treated_generated, np_original_X), axis=0)
        np_treated_ps = np.concatenate((ps_score_list_treated_np,
                                        np_original_ps_score), axis=0)
        np_treated_gen_f = np_treated_gen_f.ravel()
        np_treated_gen_y_0 = np_treated_gen_y_0.ravel()
        np_treated_gen_y_1 = np_treated_gen_y_1.ravel()

        np_treated_f = np.concatenate((np_treated_gen_f, np_original_Y_f), axis=0)
        np_treated_y_0 = np.concatenate((np_treated_gen_y_0, np_original_Y_0), axis=0)
        np_treated_y_1 = np.concatenate((np_treated_gen_y_1, np_original_Y_1), axis=0)

        return np_treated_x, np_treated_ps, np_treated_f, np_treated_y_0, np_treated_y_1
    ...
    def __execute_GAN(self, device, iter_id):
        ...
        # print(len(ps_treated_list))
        # print(len(ps_un_matched_control_list))
        # print(len(ps_matched_control_list))
        # print(len(ps_score_list_treated))
