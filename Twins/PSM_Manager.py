...
class PSM_Manager:
    def match_using_prop_score(self, tuple_treated, tuple_control):
        # do ps match
        np_treated_df_X, np_treated_ps_score, np_treated_df_Y_f, np_treated_df_Y_0, np_treated_df_Y_1 = tuple_treated
        np_control_df_X, np_control_ps_score, np_control_df_Y_f, np_control_df_Y_0, np_control_df_Y_1 = tuple_control
        ...
        tuple_matched_control, tuple_unmatched_control = self.filter_matched_and_unmatched_control_samples(
            ...
            np_control_df_Y_f,
            np_control_df_Y_0,
            np_control_df_Y_1, matched_control_indices,
    ...
    def filter_matched_and_unmatched_control_samples(self, np_control_df_X,
                                                     np_control_ps_score,
                                                     np_control_df_Y_f,
                                                     np_control_df_Y_0,
                                                     np_control_df_Y_1,
    ...
    def filter_control_groups(np_control_df_X, np_control_ps_score,
        ...
        np_filter_control_df_Y_0 = np.take(np_control_df_Y_0, indices, axis=0)
        np_filter_control_df_Y_1 = np.take(np_control_df_Y_1, indices, axis=0)
        tuple_matched_control = (np_filter_control_df_X, np_filter_control_ps_score,
                                 np_filter_control_df_Y_f, np_filter_control_df_Y_0,
                                 np_filter_control_df_Y_1)
